			...
			<div class="row">
				<div class="col-md-10">
					<section class="search-bar-wrapper">
						<div class="search-bar">
							{!! Form::open(['url'=>['subject/find'], 'method'=>'get']) !!}
				...
				<div class="col-md-2">
					@if(auth()->user()->rol->create)
						<a href="/subject/create" class="btn btn-outline-primary btn-lg btn-block">Crear</a>
					@endif
				</div>
			</div>
		</div>
		...
		<div class="table-responsive">
			<table id="table-extended-success" class="table mb-0">
				...
				<tbody>
					...
					<tr style="height: 0px">
						<td class="text-bold-600">{{ $subject->name }}</td>
						<td>{!! $subject->actions() !!}</td>
					</tr>
					@endforeach
				</tbody>
			</table>
...
<script src="/acciones/subject.js"></script>
@endsection
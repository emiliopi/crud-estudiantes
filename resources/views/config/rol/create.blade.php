...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb rounded-pill">
		...
		<li class="breadcrumb-item active" aria-current="page">Creando rol</li>
    </ol>
</nav>
@endsection
	...
	<div class="col-md-12 col-12">
		<div class="card">
			...
			<div class="card-content">
				<div class="card-body">
					{!! Form::open(['url'=>['rol/create'], 'method'=>'post']) !!}
					<div class="form-body">
						<div class="row">
							<div class="col-md-12 form-group ">
								<label for="titulo">Título</label>
								<div class="position-relative has-icon-left">
									{!! Form::text('titulo',null,['class'=>'form-control','id'=>'titulo', 'placeholder' => 'Título']) !!}
							...
							<div class="col-md-12 form-group">
								...
								{!! Form::select('permisos[]', $submenus, null ,['class'=>'select2 form-control','id'=>'permisos', 'multiple']); !!}
							</div>
							<div class="col-md-12 form-group">
								<ul class="list-unstyled mb-0">
									...
									<li class="d-inline-block mr-2 mb-1">
										<fieldset>
											<div class="custom-control custom-checkbox">
												{!! Form::checkbox('create', 1, false, ['class'=> 'custom-control-input bg-primary','readonly','id'=>'customColorCheck2']) !!}
									...
									<li class="d-inline-block mr-2 mb-1">
										<fieldset>
											<div class="custom-control custom-checkbox">
												{!! Form::checkbox('edit', 1, false, ['class'=> 'custom-control-input bg-primary','readonly','id'=>'customColorCheck3']) !!}
									...
									<li class="d-inline-block mr-2 mb-1">
										<fieldset>
											<div class="custom-control custom-checkbox">
												{!! Form::checkbox('cancel', 1, false, ['class'=> 'custom-control-input bg-primary','readonly','id'=>'customColorCheck4']) !!}
									...
									<li class="d-inline-block mr-2 mb-1">
										<fieldset>
											<div class="custom-control custom-checkbox">
												{!! Form::checkbox('delete', 1, false, ['class'=> 'custom-control-input bg-primary','readonly','id'=>'customColorCheck5']) !!}
